# No-defense utility baseline on JSONSchemaBench.
# Same as delex utility but with unmodified schemas -- provides the clean
# baseline for comparing DeLex-JSON's impact on benign structured output quality.
    ...
    for subset in subsets:
        ...
        for idx, fpath in enumerate(files):
            ...
            if (idx + 1) % 100 == 0 or new_processed % 50 == 0:
                print(f"  [{idx+1}/{total}] valid={json_valid_count}, compliant={schema_compliant_count}, new={new_processed}")
